...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		var titleText:Alphabet = new Alphabet(75, 45, title, false);
		...
		{
			var optionText:Alphabet = new Alphabet(150, 280, optionsArray[i].name, true);
			...
			{
				var checkbox:CheckboxThingie = new CheckboxThingie(optionText.x - 105, optionText.y - 1000, Std.string(optionsArray[i].getValue()) == 'true');
			...
			else
			{
				...
				//optionText.xAdd -= 80;
				var valueText:AttachedText = new AttachedText('' + optionsArray[i].getValue(), optionText.width + 60, -5, true);
